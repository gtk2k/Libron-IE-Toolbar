...
namespace BandObjectLib
{
    ...
    public class BandObject : UserControl, IObjectWithSite, IDeskBand, IDockingWindow, IOleWindow, IInputObject
    {
        ...
        /// <summary>
        /// Property for the dwModeFlags field in the DESKBANDINFO structure.
        /// Uses a Bit Flags Type convertor to allow easy editing in the property grid.
        /// </summary>
        [TypeConverter(typeof(FlagsEnumConverter))]
        [Category("Layout")]
        public DBIMF ViewMode
        {
            get { return viewMode; }
            set { viewMode = value; }
        } DBIMF viewMode;
